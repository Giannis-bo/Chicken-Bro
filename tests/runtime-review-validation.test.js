...
function validReview() {
  return {
    ...
    reviewRecord: {
      ...
      assetSemantics: [{ slotId: 'asset_slot.news-frame', expectedRole: 'frame', runtimeRole: 'frame', promotionStatus: 'production_promoted', status: 'PASS' }],
...
test('runtime review rejects incomplete or contradictory pass evidence', () => {
  const mutations = [
    ...
    (review) => { review.reviewRecord.assetSemantics[0].promotionStatus = 'candidate_pending_runtime_review' },
