...
class NewsBackendTest(unittest.TestCase):
    ...
    def test_gear_evidence_gap_health_reports_manual_capacity_review_without_claiming_it_ready(self):
        class GapStore:
            def health_summary(self, *, now):
                return {
                    "checkedAt": "2026-07-27T01:02:03+00:00",
                    "queueInputRevision": "gear-evidence-gap-input-v1:queue-r3",
                    "statusCounts": {
                        "pending": 0,
                        "running": 0,
                        "retryable": 0,
        ...
        self.assertEqual(component["status"], "partial")
        self.assertEqual(component["details"]["queue"]["manual_pending"], 1)
        self.assertEqual(component["details"]["readiness"], "manual_review")
    ...
    def test_runtime_websim_gear_returns_stale_postgres_payload_without_sqlite_fallback(self):
        ...
        self.assertEqual(payload["attributeCalculator"]["status"], "available")
    ...
    def test_runtime_websim_gear_adds_verified_attribute_calculator_to_postgres_payload(self):
        initial_payload = {
            "schemaRevision": "websim-gear-v1",
            "classKey": "mage",
            "specKey": "frost",
        ...
        self.assertEqual([rule["contextKey"] for rule in calculator["rules"]], ["mage:frost:90:dwarf"])
