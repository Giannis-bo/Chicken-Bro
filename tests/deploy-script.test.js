...
test('community template sync has a six-hour persistent systemd timer', () => {
  ...
  assert.match(service, /Environment=WOW_RAIDERIO_SPEC_RANKING_GAP_FILL_REGIONS=cn,tw,kr,us,eu/)
  assert.match(service, /Environment=WOW_RAIDERIO_SPEC_RANKING_GAP_FILL_PAGES=4/)
  assert.doesNotMatch(service, /Environment=WOW_RAIDERIO_SPEC_RANKING_GAP_FILL_EXTRA_START_PAGES=/)
  assert.match(service, /Environment=WOW_RAIDERIO_SPEC_RANKING_GAP_FILL_PAGE_SIZE=50/)
  assert.match(service, /Environment=WOW_RAIDERIO_RUN_DETAIL_LIMIT=1400/)
  assert.match(service, /Environment=WOW_RAIDERIO_RUN_DETAIL_LIMIT_PER_SPEC=32/)
  assert.match(service, /Environment=WOW_RAIDERIO_GAP_FILL_RUN_DETAIL_LIMIT=1400/)
  assert.match(service, /Environment=WOW_RAIDERIO_GAP_FILL_RUN_DETAIL_LIMIT_PER_SPEC=48/)
  assert.match(service, /Environment=WOW_RAIDERIO_GAP_FILL_RUN_DETAIL_FRONTLOAD_PER_SPEC=32/)
  assert.match(service, /Environment=WOW_RAIDERIO_TALENT_LOADOUT_LIMIT_PER_SPEC=24/)
  assert.match(service, /Environment=WOW_RAIDERIO_COMMUNITY_TEMPLATE_LIMIT=1400/)
