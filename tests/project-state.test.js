...
const activeRelease = 'artifacts/releases/2026-07-11-equipment-simulator-phase3a-resolve-profile-api'
...
test('project-state is the single machine-readable current truth entry', () => {
  ...
  assert.equal(state.activeMilestone, 'equipment_simulator_phase3')
