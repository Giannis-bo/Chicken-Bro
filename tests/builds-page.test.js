...
test('native talent simulator page exposes WebSim tree controls and SimC handoff', () => {
  ...
  assert.match(wxml, /class="talent-board-scroll"/)
  assert.match(wxml, /talent-column class/)
  assert.match(wxml, /talent-column spec/)
  assert.match(wxml, /talent-column hero/)
  ...
  assert.match(css, /\.talent-board-scroll/)
