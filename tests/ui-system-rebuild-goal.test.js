...
test('current delivery evidence refuses runtime and final promotion without fresh DevTools proof', () => {
  ...
  assert.equal(audit.runtimeVerified, false)
  assert.equal(audit.finalAccepted, false)
  ...
  assert.equal(ledger.captureSafe, false)
