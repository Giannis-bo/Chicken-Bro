...
base=Path('/tmp/chickenbro-themes-final-20260908')
...
preview=Path('/var/www/chickenbro-web/previews/themes-final-20260908')
...
if sys.argv[1]=='stage':
    ...
    preview_link=old/'previews/themes-final-20260908'
