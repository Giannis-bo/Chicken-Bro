...
base=Path('/tmp/chickenbro-short-urls-20260908')
...
root=Path('/var/www/chickenbro-web/releases')/('short-urls-'+m['commit'])
preview=Path('/var/www/chickenbro-web/previews/short-urls-20260908')
nextlink=current.with_name('current.short-urls-next')
...
if sys.argv[1]=='stage':
    ...
    preview_link=old/'previews/short-urls-20260908'
