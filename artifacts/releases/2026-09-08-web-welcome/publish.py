...
base=Path('/tmp/chickenbro-welcome-20260908')
...
root=Path('/var/www/chickenbro-web/releases')/('welcome-'+m['commit'])
preview=Path('/var/www/chickenbro-web/previews/welcome-20260908')
nextlink=current.with_name('current.welcome-next')
...
if sys.argv[1]=='stage':
    ...
    preview_link=old/'previews/welcome-20260908'
