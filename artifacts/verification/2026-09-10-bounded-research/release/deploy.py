...
ALLOWED = frozenset(('server/app/chickenbro/research_budget.py', 'server/app/chickenbro/source_gateway.py', 'server/app/chickenbro/codex_adapter.py', 'server/app/chickenbro/agent/AGENTS.md', 'server/app/chickenbro/wcl_rankings.py', 'server/chickenbro_native_mcp.py', 'server/chickenbro_public_web_research.py'))
