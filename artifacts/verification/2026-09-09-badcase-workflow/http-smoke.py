...
with httpx.Client(base_url=base,timeout=510) as client:
    ...
    for packet in packets:
        ...
        entry={'case':packet['case'],'runId':first['runId'],'conversationId':conv['id'],'seconds':round(time.monotonic()-started,2),'answer':answers[0]['content'],'checks':{'terminal':True,'history':True,'ownerIsolation':True,'idempotency':True,'detached':True,'originalContext':True}}
