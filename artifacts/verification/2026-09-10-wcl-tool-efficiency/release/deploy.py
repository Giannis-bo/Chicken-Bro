...
ALLOWED = frozenset(('server/app/chickenbro/wcl_source.py', 'server/app/chickenbro/wcl_statistics.py', 'server/app/chickenbro/source_gateway.py', 'server/app/chickenbro/answer_grounding.py', 'server/chickenbro_native_mcp.py'))
