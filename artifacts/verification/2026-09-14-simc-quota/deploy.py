...
ALLOWED = frozenset(('server/app/chickenbro/research_lifecycle.py', 'server/app/chickenbro/simulation_tools.py', 'server/chickenbro_native_mcp.py', 'server/app/chickenbro/agent/AGENTS.md'))
