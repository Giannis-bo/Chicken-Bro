...
root = Path('/var/lib/chickenbro-simc-quota-20260914')
source = Path('/opt/chickenbro-candidates/simc-quota-20260914')
files = ['server/app/chickenbro/research_lifecycle.py', 'server/app/chickenbro/simulation_tools.py', 'server/chickenbro_native_mcp.py', 'server/app/chickenbro/agent/AGENTS.md']
p = root / 'deploy.py'
s = p.read_text()
...
assert base.name == 'badcase-cdc7d262a203b23707a8932fd8318c0358316cb5'
