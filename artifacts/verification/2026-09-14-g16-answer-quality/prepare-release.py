...
source = Path('/opt/chickenbro-candidates/g16-quality-20260914')
files = ['server/app/chickenbro/agent/skills/mechanics.md']
p = root / 'deploy.py'
s = p.read_text()
...
assert base.name == 'badcase-891f83b7b750058127a04c21970763c3c57e332a'
