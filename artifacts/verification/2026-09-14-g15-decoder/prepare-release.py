...
root = Path('/var/lib/chickenbro-g15-decoder-20260914')
source = Path('/opt/chickenbro-candidates/g15-decoder-20260914')
files = ['server/app/simulation/talent_editor.py']
p = root / 'deploy.py'
s = p.read_text()
...
assert base.name == 'badcase-730882f2aef78f4460295800065c5d82b7fb7d72'
