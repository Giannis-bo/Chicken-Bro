...
export const faqGroups: FaqGroup[] = [
  ...
  { title: '账号记录', description: '登录、同步与历史管理', items: [
    ...
    { question: '退出登录会删除记录吗？', answer: '不会。对话和模拟记录仍保留在当前账号下，重新登录同一账号后可以继续查看。退出 Web 不影响小程序登录。' },
    { question: '怎样删除对话？', answer: '在 Web 会话列表点击垃圾桶，或在小程序“历史对话”中点击对应会话的“删除”，确认后该对话会从两端历史列表中移除。若对话正在回复，请等待回复结束后再删除。' },
