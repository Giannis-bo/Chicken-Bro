...
def build_websim_talent_authority_read_model(
    ...
    *,
    ...
    return {
        ...
        "checkedAt": sync_state.get("checkedAt") or sync_state.get("updatedAt") or now or utc_now(),
        "runtime": {
...
def build_gear_catalog_items_read_model(
    ...
    for row in item_rows or []:
        ...
        raw_item = {
            ...
            "armorType": payload.get("armorType") or "",
            "weaponType": payload.get("weaponType") or "",
            "catalogEvidenceStatus": payload.get("catalogEvidenceStatus") or "",
            "catalogEvidenceSource": payload.get("catalogEvidenceSource") or "",
