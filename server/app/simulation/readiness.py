...
class SimcReadinessValidator:
    def validate(
        ...
        require(
            "compiler",
            runtime_capabilities.compiler_revision in {"chickenbro-simc-compiler-v1", "chickenbro-simc-compiler-v2", "chickenbro-simc-compiler-v3", "chickenbro-simc-compiler-v4"},
