module.exports = [
  ...
  },
  {
    ...
    "bodyZh": "中文正文：Wowhead 根据暴雪 PTR 开发说明整理了 12.0.5 测试服职业调整，重点涉及德鲁伊和战士相关改动。内容包括恢复德调整、武器战士、狂怒战士和防护战士的调优方向，以及部分改动在 PTR 过程中的回滚记录。\n\n这类 PTR 资讯适合关注职业强度趋势的玩家阅读，但测试服内容并不等同于正式服最终版本。页面保留来源按钮，方便玩家回到 Wowhead 原文查看暴雪说明、上下文和后续更新。",
    "channel": "测试服前瞻",
    "category": "测试服",
    "tags": [
      "ptr",
    ...
    "originalTitle": "More Class Tuning for Druids and Warriors in Patch 12.0.5 PTR Development Notes",
    "sourceId": "wowhead",
    "sourceTier": "trusted_media",
    "licenseStatus": "reference_only",
    "verificationStatus": "license_blocked",
    "sourceBadges": [],
    "canonicalTopicId": "news:381217",
    "readingMeta": {
      "bodyBlockCount": 0,
      "estimatedReadingMinutes": 1
    },
    "contentStatus": "blocked",
    "blockedReason": "license_blocked",
    "translationStatus": "seed"
  }
]
