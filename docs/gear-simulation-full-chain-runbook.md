...
- 2026-07-11 Phase 4 live acceptance：Slice 4E 由 PR #78 squash 合入 `1e4b549`。candidate-first staging refresh、风险分级 promotion、双单实例锁、bounded health/admin 和非 deploy 触发 timer 已生效；候选与 clean-main 受控运行均复用同一 high-risk Gear/Community/Manifest 候选、40/40 shadow pass、`manual_required`，active generation 9 未移动。public 40/40、11 resolved Profile + 29 truthful blocked、负向/Catalyst fail-closed、runtime parity、service/timer/log 与 rollback 均通过。Phase 4A–4E 已归档；当前进入 [Phase 5 Async Stat Snapshot Plan](plans/2026-07-11-equipment-simulator-phase5-async-stat-snapshot-plan.md)，5A 只允许 pure signature、additive PG snapshot/job schema 与 fenced repository，不能提前开放 route/worker/frontend 或 Catalyst。
