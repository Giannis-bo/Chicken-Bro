...
- 详细 schema、任务、验证、candidate/rollback 门禁见 `docs/plans/2026-07-11-equipment-simulator-phase4-release-train-plan.md`；当前只授权 Slice 4C release-scoped read-only shadow reader 与内部 bounded old/new diff，不能切换 public reader、写 Manifest/Pointer 或增加 scheduled refresh。
