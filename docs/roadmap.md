...
- 输出与坦克全专精支持已发布，治疗明确拒绝；运行源码 `0649a2e858f5`，本轮只读核对正式代码指针一致。全专精及公网验收见[发布记录](../artifacts/verification/2026-09-09-simc-all-specs/release/README.md)。

- [小程序清理](plans/2026-09-09-mini-retirement.md)：源码与文档本地清理已验证；用户确认的 186 个仅微信账号及业务数据已从正式库删除，私有备份独立恢复、演练及保留记录核对通过。18 个 QQ 与 14 个无关联账号保留。源码尚未提交或部署。
...
本轮代码清理仍处于本地已验证状态；获得提交/发布授权后再按当前 Runbook 收尾，不能由 QQ 已上线或数据清理完成推断源码已经部署。
