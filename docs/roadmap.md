...
| 正在推进 | Exact-first 与三来源 Catalog 解耦 | Pure Canonical foundation 与 source change-control 已 final PASS/APPROVED。Task 3A delivery closure 已完成：第八次 `t3a260805163536` 的 PostgreSQL evidence 保持 `runtime_verified / candidate_verified`，PR #114 已合并、scoped Harness/main-origin parity/候选资源清理已完成；正式 packet 因现行 lifecycle test 不建模 archived 而保留 closure identity `pending`。Task 4P 已完成 pure-domain 归档：exact-head PR CI run `31064766939` 成功，合并为 `d5a1f813` 并通过 post-merge scoped Harness。Task 4L 也已完成 pure-domain 归档：exact-head PR CI run `31071444226` 成功，合并为 `d4eac363` 并通过 merge-result scoped Harness。Task 3B 的 final-head cloud PostgreSQL fresh/upgrade candidate 已通过，evidence 为 `runtime_verified / candidate_verified`；它只验证 0031 disposable persistence，仍待 packet CR、exact-head PR CI 与 Harness integration closure。没有 production migration、runtime consumer、API/UI、SimC consumer、Catalog/Manifest pointer 或 generation 35 变更；4W、5A、6C、production/runtime/user-visible work 仍未授权。 | [Exact-first Catalog 设计](plans/2026-08-04-equipment-simulator-exact-first-catalog-design.md)、[Canonical Kernel 重设计](plans/2026-08-04-equipment-simulator-canonical-kernel-redesign.md)、[持久化与运行链重排](plans/2026-08-04-equipment-simulator-exact-first-persistence-resequence.md)、[Task 4L plan](plans/2026-08-06-equipment-simulator-exact-first-task4l-loadout-effect-authority.md)、[Task 3A evidence](../artifacts/releases/2026-08-04-equipment-simulator-exact-first/evidence.json)、[Task 4P evidence](../artifacts/releases/2026-08-05-equipment-simulator-exact-first-task4p/evidence.json)、[Task 4L evidence](../artifacts/releases/2026-08-06-equipment-simulator-exact-first-task4l/evidence.json)、[Task 3B evidence](../artifacts/releases/2026-08-06-equipment-simulator-exact-first-task3b/evidence.json)、[原实施计划](plans/2026-08-04-equipment-simulator-exact-first-implementation.md) |
