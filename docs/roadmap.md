...
| 正在推进 | Exact-first 与三来源 Catalog 解耦 | Pure Canonical foundation 与 source change-control 已 final PASS/APPROVED；Task 3A delivery closure、Task 4P、Task 4L pure-domain 和 Task 3B persistence delivery closure 均已完成。Task 3A 历史 candidate `t3a260805163536` 仍为 `runtime_verified`，closure `pending`。Task 3B candidate `t3b260806203541`、独立 CR、PR #117 CI、merge `61eddf45`、merge-result scoped Harness、main/origin parity 与严格限定候选资源清理均已完成；正式 packet 保持 `runtime_verified / candidate_verified` 与 closure `pending`，因为 lifecycle contract 不建模 archived。Task 4W candidate `t4w260807000500`、独立 CR、PR #118 exact-head CI `31119305966`、merge `14f47437`、merge-result scoped Harness、pre-cleanup main/origin parity 与归档均已完成；正式 packet 保持 `runtime_verified / candidate_verified` 与 closure `pending`，且严格限定的 owned cleanup 仅在该归档/parity 门后执行。范围仍只建设 `0032` owner-scoped jobs、独立 dormant worker role/service 合同；生产 migration、active runtime consumer、API/UI、SimC consumer、Catalog/Manifest pointer 与 generation 35 均未变更。Task 5A、6C 与任何用户可见路径仍需各自 packet。 | [Exact-first Catalog 设计](plans/2026-08-04-equipment-simulator-exact-first-catalog-design.md)、[Canonical Kernel 重设计](plans/2026-08-04-equipment-simulator-canonical-kernel-redesign.md)、[持久化与运行链重排](plans/2026-08-04-equipment-simulator-exact-first-persistence-resequence.md)、[Task 4L plan](plans/2026-08-06-equipment-simulator-exact-first-task4l-loadout-effect-authority.md)、[Task 3A evidence](../artifacts/releases/2026-08-04-equipment-simulator-exact-first/evidence.json)、[Task 4P evidence](../artifacts/releases/2026-08-05-equipment-simulator-exact-first-task4p/evidence.json)、[Task 4L evidence](../artifacts/releases/2026-08-06-equipment-simulator-exact-first-task4l/evidence.json)、[Task 3B evidence](../artifacts/releases/2026-08-06-equipment-simulator-exact-first-task3b/evidence.json)、[Task 4W evidence](../artifacts/releases/2026-08-06-equipment-simulator-exact-first-task4w/evidence.json)、[原实施计划](plans/2026-08-04-equipment-simulator-exact-first-implementation.md) |
