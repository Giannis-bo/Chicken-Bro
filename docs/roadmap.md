...
| 正在推进 | Exact-first 与三来源 Catalog 解耦 | Pure Canonical foundation、source change-control 与重复 effect subject ordered-multiset 纠偏的 scoped/final whole-branch reviews 均为 PASS/APPROVED、0 findings；独立 oracle 已覆盖 5,461 个重复序列，完整 Python 178/178。Source gate 只声明 `source_change_control_only`；全量 TypeScript 仍有既有 11 条 TS4111，真实 Python 3.11 未在本机执行。原 Task 3 具备开始条件但尚未启动；generation 35 未改写，也不声称真实 SimC runtime、持久化、API、候选部署、微信体验或 release 完成 | [Exact-first Catalog 设计](plans/2026-08-04-equipment-simulator-exact-first-catalog-design.md)、[Canonical Kernel 重设计](plans/2026-08-04-equipment-simulator-canonical-kernel-redesign.md)、[owner change-control replacement](plans/2026-08-04-equipment-simulator-canonical-owner-change-control.md)、[重复 effect subject 纠偏](plans/2026-08-04-equipment-simulator-duplicate-effect-subject-correction.md)、[后续实施计划](plans/2026-08-04-equipment-simulator-exact-first-implementation.md) |
