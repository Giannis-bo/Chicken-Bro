...
| 正在推进 | Exact-first 与三来源 Catalog 解耦 | Pure Canonical foundation 与 source change-control 已 final PASS/APPROVED。Task 3A 当前为 `runtime_verified` / evidence promotion re-review pending：第四次 `t3a260805120026` 已在 commit `9ffd57b05ab97be880daf65425d6de9e26609e32` / tree `4f4a857ed52d65e04ab6bccfc5b3ac4649c3d94e` 通过新的 fresh/upgrade 真实 PostgreSQL candidate，schema-v2 evidence 与 manifest 已创建并由 Harness 绑定；独立 scoped re-review、branch/CI/merge closure 与资源清理仍 pending。`t3a2608050955`、`t3a260805111623` 的 migration-chain failures 与 `t3a260805113656` runtime-passed-but-unpromotable 继续保留 literal `candidate_rerun_required / evidence_promotion_blocked` 历史；四个 run 的八库 immutable/non-reusable。获授权顺序仍为 3A -> 4P -> 4L -> 3B -> 4W，但本证据不授权 4P+；generation 35 未改写，runtimeConsumers 为空，无 production migration，也不声称真实 SimC runtime、API、微信体验、live 或 release 完成 | [Exact-first Catalog 设计](plans/2026-08-04-equipment-simulator-exact-first-catalog-design.md)、[Canonical Kernel 重设计](plans/2026-08-04-equipment-simulator-canonical-kernel-redesign.md)、[持久化与运行链重排](plans/2026-08-04-equipment-simulator-exact-first-persistence-resequence.md)、[Task 3A evidence](../artifacts/releases/2026-08-04-equipment-simulator-exact-first/evidence.json)、[原实施计划](plans/2026-08-04-equipment-simulator-exact-first-implementation.md) |
