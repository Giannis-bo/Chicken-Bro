...
| 正在推进 | Exact-first 与三来源 Catalog 解耦 | Pure Canonical foundation 与 source change-control 已 final PASS/APPROVED。Task 3A 当前为 `runtime_verified / promotion_review_pending`：origin/main 已在 merge commit `1619815c` 无历史改写集成，主线 migrations 0026-0029 原样保留，Task 3A 为唯一 0030；365 Task 3A、519 main backend、40 Node/Harness、TypeScript typecheck 与 25 Vitest 全部通过。第五次 `t3a260805125812` 又从 exact clean commit `a4c0fd04` / tree `aa0908eb` 通过 fresh 0001..0030、upgrade 0001..0029-seed-to-0030、attestation-v2 与只读 post-audit；第四次 `t3a260805120026` 保持 superseded 历史，五个 run 的十库 immutable/non-reusable。clean manifest 已通过，首轮 promotion review 的两项 evidence-only 原文保真修正已应用；最终 re-review、分支发布、CI、merge/archive closure 与资源清理仍 pending，所以 Task 3A 尚未 `已完成`。获授权顺序仍为 3A -> 4P -> 4L -> 3B -> 4W，但本工作不授权 4P+；generation 35 未改写，runtimeConsumers 为空，无 production migration，也不声称真实 SimC runtime、API、微信体验、live 或 release 完成 | [Exact-first Catalog 设计](plans/2026-08-04-equipment-simulator-exact-first-catalog-design.md)、[Canonical Kernel 重设计](plans/2026-08-04-equipment-simulator-canonical-kernel-redesign.md)、[持久化与运行链重排](plans/2026-08-04-equipment-simulator-exact-first-persistence-resequence.md)、[Task 3A evidence](../artifacts/releases/2026-08-04-equipment-simulator-exact-first/evidence.json)、[原实施计划](plans/2026-08-04-equipment-simulator-exact-first-implementation.md) |
