...
| 正在推进 | Exact-first 与三来源 Catalog 解耦 | Pure Canonical foundation 与 source change-control 已 final PASS/APPROVED；Task 3A delivery closure、Task 4P、Task 4L pure-domain、Task 3B persistence delivery closure 和 Task 4W delivery closure 均已完成。Task 3A 历史 candidate `t3a260805163536` 仍为 `runtime_verified`，closure `pending`。Task 3B candidate `t3b260806203541`、独立 CR、PR #117 CI、merge `61eddf45`、merge-result scoped Harness、main/origin parity 与候选资源清理均已完成；正式 packet 保持 `runtime_verified / candidate_verified` 与 closure `pending`，因为 lifecycle contract 不建模 archived。Task 4W candidate `t4w260807000500`、PR #118 exact-head CI `31119305966`、merge `14f47437`、merge-result scoped Harness、main/origin parity、归档与候选资源清理均已完成；正式 packet 同样保持 `runtime_verified / candidate_verified` 与 closure `pending`。Task 5A 已完成 local source/profile/job/API/client binding；页面视觉/入口不变，ready-path 仍 literal blocked。Task 5B 的 independent requirement challenge 已确认 current active source 缺口；用户已确认 Task 5C 的有界 Runtime Authority Release 设计：将现有 sealed inputs 在受控 admission 时封存为 explicit release/vector/context/occurrence index，仅闭合模板可 ready，其他保持 blocked。Task 5C implementation requirement 尚未建立，所以 inferred provider、0035+ migration、candidate、生产 activation 或 Task 6C 仍未授权。0030–0034 fresh/upgrade candidate、生产 migration/worker activation 和既有页面微信验收均未发生；Catalog/Manifest pointer、generation 35 与 async backflow 仍不在本阶段。 | [Exact-first Catalog 设计](plans/2026-08-04-equipment-simulator-exact-first-catalog-design.md)、[持久化与运行链重排](plans/2026-08-04-equipment-simulator-exact-first-persistence-resequence.md)、[Task 5A 设计](plans/2026-08-07-equipment-simulator-exact-first-task5a-api-runtime.md)、[Task 5A requirement](../artifacts/releases/2026-08-07-equipment-simulator-exact-first-task5a/requirement.json)、[Task 5B authority-source contract](plans/2026-08-07-equipment-simulator-exact-first-task5b-active-authority-source.md)、[Task 5C runtime authority release design](plans/2026-08-10-equipment-simulator-exact-first-task5c-runtime-authority-release-design.md)、[Task 5B requirement](../artifacts/releases/2026-08-07-equipment-simulator-exact-first-task5b-active-authority-source/requirement.json)、[Task 3A evidence](../artifacts/releases/2026-08-04-equipment-simulator-exact-first/evidence.json)、[Task 3B evidence](../artifacts/releases/2026-08-06-equipment-simulator-exact-first-task3b/evidence.json)、[Task 4W evidence](../artifacts/releases/2026-08-06-equipment-simulator-exact-first-task4w/evidence.json) |
