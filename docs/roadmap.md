...
| 正在推进 | Exact-first 与三来源 Catalog 解耦 | Task 1 的 v1 兼容冻结和 Exact v2 输入合同已通过独立复审；旧 Task 2 已按五轮上限停止，原 Task 3 未启动。Canonical Kernel replacement Task 1-4 已通过独立 review，当前只推进 Task 5 的 duplicate validator/raw API consolidation 与静态 owner stop gate；replacement Task 1-5 全部 review clean 前不得进入原 Task 3，不改写 generation 35 | [Exact-first Catalog 设计](plans/2026-08-04-equipment-simulator-exact-first-catalog-design.md)、[Canonical Kernel 重设计](plans/2026-08-04-equipment-simulator-canonical-kernel-redesign.md)、[replacement plan](plans/2026-08-04-equipment-simulator-canonical-kernel-implementation.md)、[后续实施计划](plans/2026-08-04-equipment-simulator-exact-first-implementation.md) |
