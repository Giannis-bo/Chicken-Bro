...
| 正在推进 | Exact-first 与三来源 Catalog 解耦 | Pure Canonical foundation 与 source change-control 已 final PASS/APPROVED。Task 3A delivery closure 已完成：第八次 `t3a260805163536` 的 PostgreSQL evidence 保持 `runtime_verified / candidate_verified`，PR #114 已合并、scoped Harness/main-origin parity/候选资源清理已完成；正式 packet 因现行 lifecycle test 不建模 archived 而保留 closure identity `pending`。Task 4P 已在独立分支达到 `local_verified`（`2e60fb5e`；125 项 focused tests、py_compile、fresh Harness 和独立 scoped/whole-branch CR 通过，direct-server import 回归已修复）；完整 profile 只余 5 项 Task 3A lifecycle/owner-gate 历史断言，严格 allowlist 下如实 blocked，不能称 full-profile pass。它仍未合并、没有 runtime identity、candidate、production、API/UI/SimC 用户路径或 release 完成。没有 DB、migration、worker、service、deploy、Catalog/Manifest pointer 或 generation 35 变更；等待 Harness User Acceptance Closure，4L、3B、4W、5A、6C、production/runtime/user-visible work 均未授权。 | [Exact-first Catalog 设计](plans/2026-08-04-equipment-simulator-exact-first-catalog-design.md)、[Canonical Kernel 重设计](plans/2026-08-04-equipment-simulator-canonical-kernel-redesign.md)、[持久化与运行链重排](plans/2026-08-04-equipment-simulator-exact-first-persistence-resequence.md)、[Task 3A evidence](../artifacts/releases/2026-08-04-equipment-simulator-exact-first/evidence.json)、[Task 4P evidence](../artifacts/releases/2026-08-05-equipment-simulator-exact-first-task4p/evidence.json)、[原实施计划](plans/2026-08-04-equipment-simulator-exact-first-implementation.md) |
