...
- `正在推进`：Web 消息 Markdown 与选择复制、WCL 数据补查（2026-09-05 用户反馈）。修复正文显示与复制；补充已验证可取的装备天赋属性及事件分页，区分未查询和来源缺失；保留通用自主分析规则。见 [任务计划](plans/2026-09-05-chickenbro-agent-rules.md)。
