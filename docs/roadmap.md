...
| 正在推进 | Exact-first 与三来源 Catalog 解耦 | Pure Canonical foundation 与 source change-control 已 final PASS/APPROVED；Task 3A 的六个 typed reload、完整 authority bundle store、0026 append-only migration、本地验证及两位独立 reviewer 的最终复审均已 PASS/APPROVED、0 findings。fresh/upgrade 两个真实 PostgreSQL candidate 尚未完成，本机缺少 psql/明确 DSN，故严格保持 `candidate_pending`，未生成 evidence/manifest。获授权顺序仍为 3A -> 4P -> 4L -> 3B -> 4W；generation 35 未改写，runtimeConsumers 为空，也不声称真实 SimC runtime、API、微信体验或 release 完成 | [Exact-first Catalog 设计](plans/2026-08-04-equipment-simulator-exact-first-catalog-design.md)、[Canonical Kernel 重设计](plans/2026-08-04-equipment-simulator-canonical-kernel-redesign.md)、[持久化与运行链重排](plans/2026-08-04-equipment-simulator-exact-first-persistence-resequence.md)、[原实施计划](plans/2026-08-04-equipment-simulator-exact-first-implementation.md) |
