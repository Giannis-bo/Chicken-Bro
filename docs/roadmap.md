...
| 正在推进 | Exact-first 与三来源 Catalog 解耦 | Task 1 的 v1 兼容冻结和 Exact v2 输入合同已通过独立复审；旧 Task 2 已按五轮上限停止。Canonical Kernel replacement Task 1-5 已全部 independent review clean，Task 2 pure sealed foundation 完成：Exact、Progression、Effect、Probe、CLI、Static Facts 与 Authority Envelope 共用唯一 primitive/bytes/seal owner，未发布 raw API 已删除并由静态 stop gate 防回归。原 Task 3 现在可开始但尚未启动，generation 35 未改写；本结论不证明真实 SimC runtime、持久化、API、候选部署、微信体验或 release 完成 | [Exact-first Catalog 设计](plans/2026-08-04-equipment-simulator-exact-first-catalog-design.md)、[Canonical Kernel 重设计](plans/2026-08-04-equipment-simulator-canonical-kernel-redesign.md)、[replacement plan](plans/2026-08-04-equipment-simulator-canonical-kernel-implementation.md)、[后续实施计划](plans/2026-08-04-equipment-simulator-exact-first-implementation.md) |
