...
| WebSim 工作台 | 已完成 | 已把天赋编码、完整核心装备 SimC-ready 校验、canonical WebSim profile、任务保存和真实 SimC 执行连成基础闭环。 | `websim/`, `server/websim_payload.py` |
