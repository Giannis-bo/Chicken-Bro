...
| 待决策 | Exact-first 与三来源 Catalog 解耦 | Pure Canonical foundation 与 source change-control 已 final PASS/APPROVED。Task 3A delivery closure 已完成：第八次 `t3a260805163536` 的 PostgreSQL evidence 保持 `runtime_verified / candidate_verified`，PR #114 已合并、scoped Harness/main-origin parity/候选资源清理已完成；正式 packet 因现行 lifecycle test 不建模 archived 而保留 closure identity `pending`。Task 4P 已在独立分支实现并经过 task review、三轮 scoped fix 与 final fix wave，但 final scoped re-review 仍复现 mixed genuine-bundle dependency closure 及 non-list occurrence/boolean ordinal fail-closed P1；其 packet 已从不成立的 `local_verified` 降为 `implementation_allowed`，分支未合并/推送，等待新的明确修复授权。没有 DB、migration、worker、service、deploy、API、UI、Catalog/Manifest pointer 或 generation 35 变更；4L、3B、4W、5A、6C、production/runtime/user-visible work 均未授权，也不声称 SimC、API、微信、live 或 release 完成 | [Exact-first Catalog 设计](plans/2026-08-04-equipment-simulator-exact-first-catalog-design.md)、[Canonical Kernel 重设计](plans/2026-08-04-equipment-simulator-canonical-kernel-redesign.md)、[持久化与运行链重排](plans/2026-08-04-equipment-simulator-exact-first-persistence-resequence.md)、[Task 3A evidence](../artifacts/releases/2026-08-04-equipment-simulator-exact-first/evidence.json)、[Task 4P evidence](../artifacts/releases/2026-08-05-equipment-simulator-exact-first-task4p/evidence.json)、[原实施计划](plans/2026-08-04-equipment-simulator-exact-first-implementation.md) |
