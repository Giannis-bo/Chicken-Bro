...
| 2. Identity/数据面 | `local_verified`；candidate apply 容量/恢复 blocked | product schema、identity repo/app/API、Origin/CSRF、provision dry-run、dependency-loaded backend profile | 真实 PG、独立备份、恢复、candidate DB | 不切正式 DSN；blocked 不算 Phase 完成 |
