...
状态：`已完成（仅 duplicate-subject correction 与 pure-foundation whole-branch PASS/APPROVED；replacement Task 3A 当前为 candidate_failed / migration_chain_blocked，原 Task 3 继续停止）`
