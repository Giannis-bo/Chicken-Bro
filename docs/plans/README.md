...
| 炸鸡队长 Smart Question Chain | 正在推进（已授权在线 QuestionFrame、受控当前来源与 Trace observation；不含 Toolsmith/shadow/canary/promotion） | [设计](2026-08-03-chickenbro-smart-question-chain-design.md) · [实施计划](2026-08-03-chickenbro-smart-question-chain-implementation.md) · [Evidence Planner 设计](2026-08-04-chickenbro-evidence-planner-design.md) · [Evidence Planner 实施计划](2026-08-04-chickenbro-evidence-planner-implementation.md) |
