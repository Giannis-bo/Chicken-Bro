...
| 装备模拟 Catalog / Exact Instance 目标架构 | Phase 0 已完整归档；Phase 1 从 dormant `CatalogRevision + ItemDefinition + BrowseVariant membership` 合同开始 | [目标架构](2026-07-28-equipment-simulator-target-architecture.md) · [Phase 0 归档证据](../../artifacts/releases/2026-07-28-equipment-simulator-phase0-unblock/evidence.json) · [Track Authority 设计](2026-07-28-equipment-simulator-track-authority-correction.md) · [Track Authority 实施计划](2026-07-28-equipment-simulator-track-authority-implementation.md) · [Phase 0 实施计划](2026-07-28-equipment-simulator-catalog-migration-phase0-implementation.md) |
