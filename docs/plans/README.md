...
- `已完成`：[Web 插画主题](2026-09-07-web-illustration-themes.md)，用户确认六张插画上色并增加头像菜单主题切换；伊利丹暂缓。
...
- `正在推进`：[WCL 历史战斗天赋](2026-09-08-wcl-fight-talents.md)，用户授权修复示例日志导入及保存必要映射/样本；隔离验证后待发布。
