...
| 炸鸡队长 Codex 自主研究循环 | 正在推进（候选将验证通用网页 Tool 的自主选用；不写死站点、职业或结论） | [设计](2026-08-04-chickenbro-agentic-research-design.md) · [实施计划](2026-08-04-chickenbro-agentic-research-loop-implementation.md) · [通用网页 Tool 合同](2026-08-04-chickenbro-generic-public-web-research-tool.md) |
