...
只有本页列出的当前计划拥有执行权。不要按日期扫描本目录，也不要从目录存在、Git 历史或旧 release packet 推断当前任务。
...
| 装备模拟 Catalog / Exact Instance 目标架构 | Phase 0 解除阻塞正在推进；已定位 12 件装备 × 4 轨道静态属性、Community 构建内存放大、资源未知和 5 个 tooling caller 根因；Phase 1 仍阻塞（下一计划 `none`） | [目标架构](2026-07-28-equipment-simulator-target-architecture.md) · [Phase 0 解除阻塞计划](2026-07-28-equipment-simulator-phase0-unblock.md) · [Track Authority 设计](2026-07-28-equipment-simulator-track-authority-correction.md) · [Track Authority 实施计划](2026-07-28-equipment-simulator-track-authority-implementation.md) · [Phase 0 实施计划](2026-07-28-equipment-simulator-catalog-migration-phase0-implementation.md) · [当前审计](../../artifacts/releases/2026-07-28-equipment-simulator-track-authority-correction/runtime-readonly-audit.json) · [当前 Phase 1 决策](../../artifacts/releases/2026-07-28-equipment-simulator-track-authority-correction/phase1-decision.json) |
