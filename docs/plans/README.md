...
| 装备模拟 Catalog / Exact Instance 目标架构 | Phase 0 运行态与数据门禁已验证；两项真实微信验收及合入收口待完成，完成前不并行启动 Phase 1 schema/runtime 切换 | [目标架构](2026-07-28-equipment-simulator-target-architecture.md) · [Phase 0 解除阻塞计划](2026-07-28-equipment-simulator-phase0-unblock.md) · [当前 Phase 0 证据](../../artifacts/releases/2026-07-28-equipment-simulator-phase0-unblock/evidence.json) · [Track Authority 设计](2026-07-28-equipment-simulator-track-authority-correction.md) · [Track Authority 实施计划](2026-07-28-equipment-simulator-track-authority-implementation.md) · [Phase 0 实施计划](2026-07-28-equipment-simulator-catalog-migration-phase0-implementation.md) |
