...
| 装备模拟 Exact-first 与三来源 Catalog | 正在推进（Task 3A 已完成 delivery closure：历史 candidate `t3a260805163536` 仍为 `runtime_verified`，closure `pending`；Task 4P/4L pure-domain 已归档。Task 3B delivery closure 已完成：candidate `t3b260806203541`、独立 CR、PR #117 CI、merge `61eddf45`、scoped Harness、main/origin parity 与候选资源清理均完成；正式 packet 保持 `runtime_verified / candidate_verified` 与 closure `pending`，因为 lifecycle contract 不建模 archived。Task 4W delivery closure 已完成：candidate `t4w260807000500`、PR #118 exact-head CI `31119305966`、merge `14f47437`、merge-result scoped Harness、main/origin parity、归档与候选资源清理均完成；正式 packet 同样保持 `runtime_verified / candidate_verified` 与 closure `pending`。Task 5A 的 local foundation、strict Exact API/client 与不改视觉的当前 `simc_submit` binding 已完成，但 ready-path 继续 literal blocked。Task 5B 已冻结为 `requirement_challenged`：当前不存在可证明八项 vector 与动态 occurrence relation 的 active authority source，故不授权 provider、migration、candidate、生产或 Task 6C；Task 6C 仍无授权） | [设计](2026-08-04-equipment-simulator-exact-first-catalog-design.md) · [持久化与运行链重排](2026-08-04-equipment-simulator-exact-first-persistence-resequence.md) · [Task 5A 设计](2026-08-07-equipment-simulator-exact-first-task5a-api-runtime.md) · [Task 5A requirement](../../artifacts/releases/2026-08-07-equipment-simulator-exact-first-task5a/requirement.json) · [Task 5B authority-source contract](2026-08-07-equipment-simulator-exact-first-task5b-active-authority-source.md) · [Task 5B requirement](../../artifacts/releases/2026-08-07-equipment-simulator-exact-first-task5b-active-authority-source/requirement.json) · [Task 3A evidence](../../artifacts/releases/2026-08-04-equipment-simulator-exact-first/evidence.json) · [Task 3B evidence](../../artifacts/releases/2026-08-06-equipment-simulator-exact-first-task3b/evidence.json) · [Task 4W evidence](../../artifacts/releases/2026-08-06-equipment-simulator-exact-first-task4w/evidence.json) |
