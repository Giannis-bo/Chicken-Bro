...
| 装备模拟 Catalog / Exact Instance 目标架构 | Phase 0 审计口径校正完成；Track Authority 阻塞修正书面设计待复核；迁移仍阻塞（下一计划 `none`） | [目标架构](2026-07-28-equipment-simulator-target-architecture.md) · [Track Authority 修正](2026-07-28-equipment-simulator-track-authority-correction.md) · [Phase 0 实施计划](2026-07-28-equipment-simulator-catalog-migration-phase0-implementation.md) · [当前审计结果](../../artifacts/releases/2026-07-28-equipment-simulator-catalog-migration-phase0/phase1-decision.json) |
