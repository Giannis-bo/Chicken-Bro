...
| 炸鸡队长 Smart Question Chain | 等待用户验收（Evidence Planner 与 Codex 自主研究循环均已候选验证；真实 WeChat 验收待办；不含新来源接入、Toolsmith/shadow/canary/promotion） | [设计](2026-08-03-chickenbro-smart-question-chain-design.md) · [实施计划](2026-08-03-chickenbro-smart-question-chain-implementation.md) · [Evidence Planner 设计](2026-08-04-chickenbro-evidence-planner-design.md) · [Evidence Planner 实施计划](2026-08-04-chickenbro-evidence-planner-implementation.md) · [Evidence Planner 候选证据](../../artifacts/releases/2026-08-04-chickenbro-evidence-planner/evidence.json) · [自主研究循环设计](2026-08-04-chickenbro-agentic-research-design.md) · [自主研究循环实施计划](2026-08-04-chickenbro-agentic-research-loop-implementation.md) · [自主研究循环候选证据](../../artifacts/releases/2026-08-04-chickenbro-agentic-research-loop/evidence.json) |
| 炸鸡队长 Codex 自主研究循环 | 等待用户验收（最终候选运行、ToolBox 执行/观察后再规划、Trace 和候选 WeChat 包已验证；新来源不在本切片） | [设计](2026-08-04-chickenbro-agentic-research-design.md) · [实施计划](2026-08-04-chickenbro-agentic-research-loop-implementation.md) · [候选证据](../../artifacts/releases/2026-08-04-chickenbro-agentic-research-loop/evidence.json) |
