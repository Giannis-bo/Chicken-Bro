...
| 装备模拟 Catalog / Exact Instance 目标架构 | Track Authority 实现与生产只读重跑完成；1,313 个 canonical 候选中 1,265 个可映射，48 个缺静态属性；Phase 1 仍阻塞（下一计划 `none`） | [目标架构](2026-07-28-equipment-simulator-target-architecture.md) · [Track Authority 设计](2026-07-28-equipment-simulator-track-authority-correction.md) · [Track Authority 实施计划](2026-07-28-equipment-simulator-track-authority-implementation.md) · [Phase 0 实施计划](2026-07-28-equipment-simulator-catalog-migration-phase0-implementation.md) · [当前审计](../../artifacts/releases/2026-07-28-equipment-simulator-track-authority-correction/runtime-readonly-audit.json) · [当前 Phase 1 决策](../../artifacts/releases/2026-07-28-equipment-simulator-track-authority-correction/phase1-decision.json) |
