...
| 装备模拟 Exact-first 与三来源 Catalog | 正在推进（Task 3A 已完成 delivery closure：历史 candidate `t3a260805163536` 仍为 `runtime_verified`，closure `pending`；Task 4P/4L pure-domain 已归档。Task 3B delivery closure 已完成：candidate `t3b260806203541`、独立 CR、PR #117 CI、merge `61eddf45`、scoped Harness、main/origin parity 与候选资源清理均完成；正式 packet 保持 `runtime_verified / candidate_verified` 与 closure `pending`，因为 lifecycle contract 不建模 archived。Task 4W delivery closure 已完成：candidate `t4w260807000500`、PR #118 exact-head CI `31119305966`、merge `14f47437`、merge-result scoped Harness、main/origin parity、归档与候选资源清理均完成；正式 packet 同样保持 `runtime_verified / candidate_verified` 与 closure `pending`。Task 5A 的独立设计、requirement、generic Exact confirm/submit/read、0033 source binding/admission/replay 与 injected v2 materializer/worker 本地 TDD foundation 已建立；它保持 `simc_submit` UI 视觉/入口不变。用户已批准 0034 v2 job→snapshot canonical binding，且确认只有 remote saved talent template 可由 server reload/compile 进入 Exact；client raw profile、local/handoff 与不受服务器 options 验证的 race/scenario 全部 literal blocked。完整 active loadout/effect/profile materialization、route/UI binding、candidate、生产 0030--0034 migration、worker activation 或真实微信验收均未发生；Task 6C 仍无授权） | [设计](2026-08-04-equipment-simulator-exact-first-catalog-design.md) · [持久化与运行链重排](2026-08-04-equipment-simulator-exact-first-persistence-resequence.md) · [Task 5A 设计](2026-08-07-equipment-simulator-exact-first-task5a-api-runtime.md) · [Task 5A requirement](../../artifacts/releases/2026-08-07-equipment-simulator-exact-first-task5a/requirement.json) · [Task 3A evidence](../../artifacts/releases/2026-08-04-equipment-simulator-exact-first/evidence.json) · [Task 3B evidence](../../artifacts/releases/2026-08-06-equipment-simulator-exact-first-task3b/evidence.json) · [Task 4W evidence](../../artifacts/releases/2026-08-06-equipment-simulator-exact-first-task4w/evidence.json) |
