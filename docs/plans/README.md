...
| 装备模拟 Exact-first 与三来源 Catalog | 正在推进（replacement Canonical Kernel Task 1；原 Task 3 未启动） | [设计](2026-08-04-equipment-simulator-exact-first-catalog-design.md) · [实施计划](2026-08-04-equipment-simulator-exact-first-implementation.md) |
| 装备模拟 Canonical Kernel 重设计 | 正在推进（Subagent-Driven，Task 1） | [重设计](2026-08-04-equipment-simulator-canonical-kernel-redesign.md) · [实施计划](2026-08-04-equipment-simulator-canonical-kernel-implementation.md) |
