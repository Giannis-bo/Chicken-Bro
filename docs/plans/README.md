...
| 装备模拟 Catalog / Exact Instance 目标架构 | Phase 1 已归档；Phase 2 正在实现 dormant `ExactItemInstance + EnhancementSelection` 及 Community/个人模板 shadow | [目标架构](2026-07-28-equipment-simulator-target-architecture.md) · [Phase 2 实施计划](2026-07-29-equipment-simulator-phase2-exact-enhancement.md) · [Phase 1 归档证据](../../artifacts/releases/2026-07-29-equipment-simulator-phase1-catalog-contract/evidence.json) · [Phase 0 归档证据](../../artifacts/releases/2026-07-28-equipment-simulator-phase0-unblock/evidence.json) · [Track Authority 设计](2026-07-28-equipment-simulator-track-authority-correction.md) |
