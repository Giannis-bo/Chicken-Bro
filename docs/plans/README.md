...
| 装备模拟 Exact-first 与三来源 Catalog | 正在推进（Subagent-Driven，Task 1） | [设计](2026-08-04-equipment-simulator-exact-first-catalog-design.md) · [实施计划](2026-08-04-equipment-simulator-exact-first-implementation.md) |
