...
| 装备模拟 Exact-first 与三来源 Catalog | 待决策（Task 2 已达 5 轮修复上限；需重开 canonical validation 设计） | [设计](2026-08-04-equipment-simulator-exact-first-catalog-design.md) · [实施计划](2026-08-04-equipment-simulator-exact-first-implementation.md) |
| 装备模拟 Canonical Kernel 重设计 | 设计已确认；replacement plan 下一步 | [重设计](2026-08-04-equipment-simulator-canonical-kernel-redesign.md) · [实施计划](2026-08-04-equipment-simulator-canonical-kernel-implementation.md) |
