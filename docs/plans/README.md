...
| 装备模拟 Catalog / Exact Instance 目标架构 | 已批准，Phase 0 计划待审阅 | [目标架构](2026-07-28-equipment-simulator-target-architecture.md) · [Phase 0 实施计划](2026-07-28-equipment-simulator-catalog-migration-phase0-implementation.md) |
