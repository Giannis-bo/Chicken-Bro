...
| 装备模拟 Catalog / Exact Instance 目标架构 | Phase 0-2 已归档；Phase 3 正在实现 exact-only `ResolvedLoadout + SimulationSnapshot`、canonical compiler 和任务兼容 | [目标架构](2026-07-28-equipment-simulator-target-architecture.md) · [Phase 3 实施计划](2026-07-29-equipment-simulator-phase3-resolved-snapshot.md) · [Phase 2 归档证据](../../artifacts/releases/2026-07-29-equipment-simulator-phase2-exact-enhancement/evidence.json) · [Phase 1 归档证据](../../artifacts/releases/2026-07-29-equipment-simulator-phase1-catalog-contract/evidence.json) · [Phase 0 归档证据](../../artifacts/releases/2026-07-28-equipment-simulator-phase0-unblock/evidence.json) |
