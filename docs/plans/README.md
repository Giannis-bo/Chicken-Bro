...
| 装备模拟 Exact-first 与三来源 Catalog | 正在推进（Task 3A `runtime_verified` / evidence promotion PASS：第四次 `t3a260805120026` 已在 commit `9ffd57b05ab97be880daf65425d6de9e26609e32` 通过真实 fresh/upgrade PostgreSQL candidate，schema-v2 evidence 与 manifest 已由 Harness 绑定，独立 promotion review 已 PASS；branch/CI/merge/archive closure 与资源清理仍 pending。`t3a2608050955`、`t3a260805111623` 与 `t3a260805113656` 保留 literal `candidate_rerun_required / evidence_promotion_blocked` 历史，四个 run 的八库 immutable/non-reusable；无 production migration/runtime consumer，Task 4P+ 未授权） | [设计](2026-08-04-equipment-simulator-exact-first-catalog-design.md) · [原实施计划](2026-08-04-equipment-simulator-exact-first-implementation.md) · [持久化与运行链重排](2026-08-04-equipment-simulator-exact-first-persistence-resequence.md) · [Task 3A evidence](../../artifacts/releases/2026-08-04-equipment-simulator-exact-first/evidence.json) |
