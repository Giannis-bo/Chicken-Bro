...
状态：`已停止（pure foundation 的 forward replacement 与 final whole-branch re-review 已完成；replacement Task 3A 当前为 candidate_failed / migration_chain_blocked；本计划原 Task 3 继续停止）`
