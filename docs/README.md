...
| [恢复通道只读清单](refactor/chickenbro-simc-recovery-inventory.json) | 唯一系统盘快照陈旧且未做 restore，广州地域待挂载云硬盘为 0；账号已有 COS 桶与额度，但实例无客户端、CAM 角色或已审阅凭据，容量和恢复仍未验证，恢复 gate 继续 blocked。 |
